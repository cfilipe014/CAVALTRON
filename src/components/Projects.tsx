      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projects?.map((project) => (
            <Card 
              key={project.id} 
              className="border-border hover:border-accent transition-all duration-300 hover:shadow-[var(--shadow-card)] bg-card flex flex-col"
            >
              {project.image_url && (
              ...
              <CardFooter>
                <Button 
                  ...
                  disabled={!project.external_link && !project.iframe_url}
                >
                  Ver Detalhes
